...
public class Discard_ERR0060 {
	...
	public void DiscardEmail() throws InterruptedException{
		...
		Thread.sleep(2500l);
		driver.findElement(By.xpath("(//textarea[@name='_to'])[1]")).sendKeys("vivarsm@zira.com");
		...
		Thread.sleep(1000l);
		upload.uploadFile("C:\\Users\\User\\Desktop\\Zira\\Dispute\\Testing\\AutomationQA\\Email\\Discard\\ERR0060\\ATC_1.xlsx");
		Thread.sleep(2000l);
		driver.findElement(By.linkText("Attach a file")).click();
		Thread.sleep(2000l);
		upload.uploadFile("C:\\Users\\User\\Desktop\\Zira\\Dispute\\Testing\\AutomationQA\\Email\\Discard\\ERR0060\\ATC_9.xlsx");
		Thread.sleep(2000l);
