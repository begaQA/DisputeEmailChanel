...
public class Discard_MIX {
	...
	System.setProperty("webdriver.chrome.driver", "C:\\Users\\User\\Desktop\\Trening\\NEW\\chromedriver.exe");
		...
		driver.findElement(By.id("composebody")).sendKeys("Buongiorno,\r\n"
				...
				+ "\r\n"
				+ "ID Fattura OAO: C120201910000500aa\r\n"
				+ "Causale: Serviz88i disconosciuti/non consegnati\r\n"
				+ "Totale Disputato: 11112251123.3\r\n"
				+ "Note OAO: Test note OAO comment");
		driver.findElement(By.linkText("Attach a file")).click();
		Thread.sleep(1000l);
	    StringSelection stringSelection = new StringSelection("C:\\Users\\User\\Desktop\\Zira\\Dispute\\Testing\\AutomationQA\\Email\\Discard\\ERR0066\\ATC_66rows.xlsx");
